let reviews = [
    {
        id: 1,
        name: "Екатерина",
        text: "Интересное место, очень атмосферное, приветливые официанты, красивые и необычные десерты. Официант Дарья подобрала для нас десерты, учитывая наши предпочтения. Рекомендовано для посещения.",
        data: "12/10/22",
